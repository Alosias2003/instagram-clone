...
//       }}
//     >
//       <Typography variant="h4" sx={{ mb: 2, fontFamily: 'Lobster, cursive' }}>
//         Instagram
//       </Typography>
//       <Box
//         sx={{
...
//         </Button>
//       </form>
//       <Link href="#" sx={{ color: '#00376b', fontSize: 12, display: 'block', mb: 2 }}>
//         Can't reset your password?
//       </Link>
//       <Divider sx={{ my: 2 }}>OR</Divider>
//       <Link href="#" sx={{ color: '#00376b', fontSize: 14, fontWeight: 'bold', display: 'block', mb: 2 }}>
//         Create new account
//       </Link>
//       <Divider sx={{ my: 2 }} />
//       <Link href="#" sx={{ color: '#00376b', fontSize: 14, fontWeight: 'bold', display: 'block' }}>
//         Back to login
//       </Link>
//     </Box>
//   );
