...
//   if (loading) {
//     return (
//       <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', bgcolor: 'black', zIndex: 9999 }}>
...
//     return (
//       <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', bgcolor: 'black', zIndex: 9999 }}>
//         <Typography variant="h6" color="white">No stories available</Typography>
//       </Box>
//     );
//   }
...
//   // Update URL parameters when indices change
//   useEffect(() => {
...
//       });
//     }
//   }, [currentIndex, currentStoryIndex, loading, users.length, setSearchParams]);
